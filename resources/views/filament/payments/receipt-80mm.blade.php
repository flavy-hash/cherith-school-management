...
<head>
    ...
    <title>Payment Receipt (80mm) - Cherith Junior School</title>
    <style>
        ...
        .print-btn { display: block; width: 100%; margin: 10px auto 0; padding: 8px 10px; background: #000; color: #fff; border: none; border-radius: 4px; cursor: pointer; font-size: 12px; }
